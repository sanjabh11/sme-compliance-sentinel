...
- [x] Local repo includes `npm run verify:local-submission` to aggregate source-release, provenance, license/IP, Cloud Run deployment-template, and judge-access readiness gates into one local readiness report without treating local output as hosted Gemini, Google Cloud, Workspace, revenue, or user proof.
