...
- [x] Local repo includes `npm run prepare:xprize-attestation -- --out-dir /secure/local/xprize-attestation` to generate a private JSON/Markdown human-review packet for provenance, pre-existing work, license/API/IP, demo, hosted proof, and business-evidence flags without setting or approving any `XPRIZE_*` flag.
