...
- [x] Local MVP exposes `/api/production/deployment-packet` to bind release id, Cloud Run manifest state, render-values audit, hosted verification commands, hosted proof bundle artifacts, deployment execution checklist artifact, source/provenance checks, redaction rules, private storage paths, and Evidence Vault import template into one private judge-packet plan.
